...
`Godot Humanoid <https://docs.godotengine.org/en/stable/classes/class_xrnode3d.html>`_ layout.
See the Godot documentation on `Retargeting 3D Skeletons <https://docs.godotengine.org/en/stable/classes/class_xrnode3d.html>`_
for more info.
