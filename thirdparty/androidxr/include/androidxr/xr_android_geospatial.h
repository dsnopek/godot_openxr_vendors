...
// An slink:XrGeospatialTrackerANDROID which is not in ename:XR_GEOSPATIAL_TRACKER_STATE_RUNNING_ANDROID was passed to a function.
#define XR_ERROR_GEOSPATIAL_TRACKER_NOT_RUNNING_ANDROID ((XrResult) -1000789000U)
// The supplied geospatial coordinates were invalid.
#define XR_ERROR_GEOSPATIAL_COORDINATES_INVALID_ANDROID ((XrResult) -1000789001U)
// Cloud auth failed. A structure like slink:XrGoogleCloudAuthErrorResultANDROID in the next chain may: provide more information about the failure.
