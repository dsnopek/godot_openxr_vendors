...
@onready var horizontal_accuracy_field: Label = %HorizontalAccuracyField
@onready var vertical_accuracy_field: Label = %VerticalAccuracyField
@onready var orientation_valid_field: Label = %OrientationValidField
@onready var orientation_field: Label = %OrientationField
@onready var orientation_yaw_accuracy_field: Label = %OrientationYawAccuracyField
